...
<li data-thumb="product_image/174036s1.jpg">
<div class="thumb-image">
	<img src="{{ asset($allproductsImg->image_option)}}"  data-imagezoom="true" class="img-responsive"> </div>
</li>
...
{{-- <span class="pull-right btn bg-info">
<a href="{{url('/ad_card/'.$data->product_id)}}"><i class="fa fa-shopping-cart" aria-hidden="true"></i>
