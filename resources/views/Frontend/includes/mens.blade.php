...
<li>
<img class="img-responsive" src="{{ asset('public/Frontend/images/')}}/banner2.jpg" alt=" "/>
</li>
<li>
<img class="img-responsive" src="{{ asset('public/Frontend/images/')}}/banner5.jpg" alt=" "/>
</li>
<li>
<img class="img-responsive" src="{{ asset('public/Frontend/images/')}}/banner2.jpg" alt=" "/>
</li>
...
<img class="img-responsive" src="{{ asset('public/Frontend/images/')}}/bb2.jpg" alt=" " />
</div>
...
<img src="{{ asset('public/Frontend/images/')}}/m8.jpg" alt="" class="pro-image-front">
<img src="{{ asset('public/Frontend/images/')}}//m8.jpg" alt="" class="pro-image-back">
<div class="men-cart-pro">
<div class="inner-men-cart-pro">
<a href="{{ url('/page/details')}}" class="link-product-add-cart">Quick View</a>
</div>
</div>
...
<h4><a href="{{ url('/page/details')}}">Party Men's Blazer</a></h4>
...
<div class="men-pro-item simpleCart_shelfItem">
<div class="men-thumb-item">
<img src="{{ asset('public/Frontend/images/')}}/m7.jpg" alt="" class="pro-image-front">
<img src="{{ asset('public/Frontend/images/')}}/m7.jpg" alt="" class="pro-image-back">
<div class="men-cart-pro">
<div class="inner-men-cart-pro">
<a href="{{ url('/page/details')}}" class="link-product-add-cart">Quick View</a>
</div>
...
<div class="item-info-product ">
<h4>
	<a href="{{ url('/page/details')}}">Analog Watch</a>
</h4>
<div class="info-product-price">
...
<div class="men-pro-item simpleCart_shelfItem">
<div class="men-thumb-item">
<img src="{{ asset('public/Frontend/images/')}}/s1.jpg" alt="" class="pro-image-front">
<img src="{{ asset('public/Frontend/images/')}}/s1.jpg" alt="" class="pro-image-back">
<div class="men-cart-pro">
<div class="inner-men-cart-pro">
<a href="{{ url('/page/details')}}" class="link-product-add-cart">Quick View</a>
</div>
...
<div class="item-info-product ">
<h4><a href="{{ url('/page/details')}}">Running Shoes</a></h4>
<div class="info-product-price">
...
<div class="men-pro-item simpleCart_shelfItem">
<div class="men-thumb-item">
<img src="{{ asset('public/Frontend/images/')}}/m1.jpg" alt="" class="pro-image-front">
<img src="{{ asset('public/Frontend/images/')}}/m1.jpg" alt="" class="pro-image-back">
<div class="men-cart-pro">
<div class="inner-men-cart-pro">
<a href="{{ url('/page/details')}}" class="link-product-add-cart">Quick View</a>
</div>
...
<div class="item-info-product ">
<h4><a href="{{ url('/page/details')}}">Formal Blue Shirt</a></h4>
<div class="info-product-price">
...
<div class="men-pro-item simpleCart_shelfItem">
<div class="men-thumb-item">
<img src="{{ asset('public/Frontend/images/')}}/m2.jpg" alt="" class="pro-image-front">
<img src="{{ asset('public/Frontend/images/')}}/m2.jpg" alt="" class="pro-image-back">
<div class="men-cart-pro">
<div class="inner-men-cart-pro">
<a href="{{ url('/page/details')}}" class="link-product-add-cart">Quick View</a>
</div>
...
<div class="item-info-product ">
<h4><a href="{{ url('/page/details')}}">Gabi Full Sleeve Sweatshirt</a></h4>
<div class="info-product-price">
<span class="item_price">$45.99</span>
<del>$69.71</del>
</div>
...
<div class="men-pro-item simpleCart_shelfItem">
<div class="men-thumb-item">
<img src="{{ asset('public/Frontend/images/')}}/m3.jpg" alt="" class="pro-image-front">
<img src="{{ asset('public/Frontend/images/')}}/m3.jpg" alt="" class="pro-image-back">
<div class="men-cart-pro">
<div class="inner-men-cart-pro">
<a href="{{ url('/page/details')}}" class="link-product-add-cart">Quick View</a>
</div>
...
<div class="item-info-product ">
<h4><a href="{{ url('/page/details')}}">Dark Blue Track Pants</a></h4>
<div class="info-product-price">
<span class="item_price">$80.99</span>
<del>$89.71</del>
</div>
...
<div class="men-pro-item simpleCart_shelfItem">
<div class="men-thumb-item">
<img src="{{ asset('public/Frontend/images/')}}/m4.jpg" alt="" class="pro-image-front">
<img src="{{ asset('public/Frontend/images/')}}/m4.jpg" alt="" class="pro-image-back">
<div class="men-cart-pro">
<div class="inner-men-cart-pro">
<a href="{{ url('/page/details')}}" class="link-product-add-cart">Quick View</a>
</div>
...
<div class="item-info-product ">
<h4><a href="{{ url('/page/details')}}">Round Neck Black T-Shirt</a></h4>
<div class="info-product-price">
...
<div class="men-pro-item simpleCart_shelfItem">
<div class="men-thumb-item">
<img src="{{ asset('public/Frontend/images/')}}/m5.jpg" alt="" class="pro-image-front">
<img src="{{ asset('public/Frontend/images/')}}/m5.jpg" alt="" class="pro-image-back">
<div class="men-cart-pro">
<div class="inner-men-cart-pro">
<a href="{{ url('/page/details')}}" class="link-product-add-cart">Quick View</a>
</div>
...
<div class="item-info-product ">
<h4><a href="{{ url('/page/details')}}">Men's Black Jeans</a></h4>
<div class="info-product-price">
...
<div class="item-info-product ">
<h4><a href="{{ url('/page/details')}}">Analog Watch</a></h4>
<div class="info-product-price">
<span class="item_price">$160.99</span>
<del>$290.71</del>
</div>
...
<div class="men-pro-item simpleCart_shelfItem">
<div class="men-thumb-item">
<img src="{{ asset('public/Frontend/images/')}}/m6.jpg" alt="" class="pro-image-front">
<img src="{{ asset('public/Frontend/images/')}}/m6.jpg" alt="" class="pro-image-back">
<div class="men-cart-pro">
<div class="inner-men-cart-pro">
<a href="{{ url('/page/details')}}" class="link-product-add-cart">Quick View</a>
</div>
...
<div class="item-info-product ">
<h4><a href="{{ url('/page/details')}}">Reversible Belt</a></h4>
<div class="info-product-price">
